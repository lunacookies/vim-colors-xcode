...
" Last Updated: Sat Feb 29 09:10:40 2020
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  if !exists('g:xcodedark_emph_statements')
    let g:xcodedark_emph_statements = 1
  endif
  ...
  if g:xcodedark_emph_statements
    hi Statement guifg=#ff7ab2 guibg=NONE guisp=NONE gui=bold cterm=bold
  else
    hi Statement guifg=#ff7ab2 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  endif

...
" Last Updated: Sat Feb 29 09:31:44 2020
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  if !exists('g:xcodelighthc_emph_statements')
    let g:xcodelighthc_emph_statements = 1
  endif
  ...
  if g:xcodelighthc_emph_statements
    hi Statement guifg=#9c2191 guibg=NONE guisp=NONE gui=bold cterm=bold
  else
    hi Statement guifg=#9c2191 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  endif
...
if s:t_Co >= 256
  ...
  if g:xcodelighthc_emph_statements
    ...
    hi Statement ctermfg=126 ctermbg=NONE cterm=NONE
  endif
  if g:xcodelighthc_match_paren_style
    hi MatchParen ctermfg=16 ctermbg=227 cterm=NONE
  else
